                ...
                <div class="row"><!-- first row -->
                    ...
                    <div class="col-md-8">
                        <div class="widget-item">
                            ...
                            <h4 class="consult-title">Event Planning</h4>
                            <p>A dynamic Travel Agent, tour operator and Travel Management Company with a unique vision of absolute and unwavering commitment to offering affordable, yet professional and quality-infused, business and leisure travel services.</p>
                        </div> <!-- /.widget-item -->
                    </div> <!-- /.col-md-4 -->
                    ...
                    <div class="col-md-4"><!-- third column -->
                        <div class="widget-item">
                            ...
                            <h4 class="consult-title">DThe Complete Event Planning Guide</h4>
                            <p> Looking for how to plan an event, or advice on event planning? 
                            ...
                            While we can't identify all of the details you’ll need to think about, since much of it will depend on the type of event you are holding, we can suggest some best practices that are important to follow for any event. </p>
                        </div> 
                    </div> <!-- /.col-md-4 -->
